                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-end"><?= number_format($pending_member['fee_capital'] ?? 50, 2) ?></td>
                            </tr>
                            <tr>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="loan_type" class="form-select form-select-sm">
                                        ...
                                        <option value="Pembiayaan_RoadTaxInsuran">Pembiayaan RoadTax/Insuran</option>
