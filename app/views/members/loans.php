                            ...
                            <div class="card-body">
                                <div class="loans-grid">
                                    ...
                                    <div class="loan-container">
                                        <h3 class="loan-title">Pembiayaan Al Bai</h3>
                                        <ul class="loan-features">
                                            ...
                                            <li><i class="fas fa-check-circle"></i> Jumlah: RM1,000 - RM50,000</li>
                                        </ul>
                                        <div class="button-group">
                                            <a href="#" class="learn-more-button" onclick="showDetails('albai')">Maklumat Lanjut</a>
                                    ...
                                    <!-- Al Innah Loan -->
                                    <div class="loan-container">
                                        <h3 class="loan-title">Pembiayaan Al Innah</h3>
                                        <ul class="loan-features">
                                            <li><i class="fas fa-check-circle"></i> Kadar keuntungan: 4.2% setahun</li>
                                            <li><i class="fas fa-check-circle"></i> Tempoh: 1 - 10 tahun</li>
                                            <li><i class="fas fa-check-circle"></i> Jumlah: RM1,000 - RM50,000</li>
                                        ...
                                        <div class="button-group">
                                            <a href="#" class="learn-more-button" onclick="showDetails('alinnah')">Maklumat Lanjut</a>
                                            <a href="#" class="apply-button" onclick="checkProfileStatus()">Mohon</a>
                                        </div>
                                    </div>
                                    ...
                                    <!-- Skim Khas Loan -->
                                    <div class="loan-container">
                                        <h3 class="loan-title">Pembiayaan Skim Khas</h3>
                                        <ul class="loan-features">
                                            <li><i class="fas fa-check-circle"></i> Kadar keuntungan: 4.2% setahun</li>
                                            <li><i class="fas fa-check-circle"></i> Tempoh: 1 - 10 tahun</li>
                                            <li><i class="fas fa-check-circle"></i> Jumlah: RM1,000 - RM100,000</li>
                                        </ul>
                                        <div class="button-group">
                                            <a href="#" class="learn-more-button" onclick="showDetails('peribadi')">Maklumat Lanjut</a>
                                            <a href="#" class="apply-button" onclick="checkProfileStatus()">Mohon</a>
                                        </div>
                                    </div>

                                    <!-- Road Tax & Insurance Loan -->
                                    <div class="loan-container">
                                        <h3 class="loan-title">Pembiayaan Road Tax & Insuran</h3>
                                        <ul class="loan-features">
                                            <li><i class="fas fa-check-circle"></i> Kadar keuntungan: 4.2% setahun</li>
                                            <li><i class="fas fa-check-circle"></i> Tempoh: sehingga 9 tahun</li>
                                            <li><i class="fas fa-check-circle"></i> Margin: sehingga 90%</li>
                                        </ul>
                                        <div class="button-group">
                                    ...
                                    <div class="loan-container">
                                        <h3 class="loan-title">Pembiayaan Al Qardhul Hasan</h3>
                                        <ul class="loan-features">
                                            <li><i class="fas fa-check-circle"></i> Kadar keuntungan: 4.2% setahun</li>
                                            <li><i class="fas fa-check-circle"></i> Tempoh: sehingga 35 tahun</li>
                                            <li><i class="fas fa-check-circle"></i> Margin: sehingga 90%</li>
                                        </ul>
                                        <div class="button-group">
                                            <a href="#" class="learn-more-button" onclick="showDetails('perumahan')">Maklumat Lanjut</a>
                                            <a href="#" class="apply-button" onclick="checkProfileStatus()">Mohon</a>
                                        </div>
                                    </div>
                                </div>
