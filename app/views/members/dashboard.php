                ...
                <?php else: ?>
                    ...
                    <div class="welcome-section py-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <h2 class="h5 mb-1"><?php echo htmlspecialchars($member->full_name ?? 'Tetamu'); ?></h2>
                                <small class="text-muted">
                                    <i class="fas fa-clock me-1"></i>
                                    <?php echo date('d M Y, H:i A', strtotime($member->last_login ?? 'now')); ?>
                                </small>
                            </div>
                        </div>
                    </div>
