    ...
    <div class="profile-sidebar" id="profileSidebar">
        <div class="sidebar-content">
            ...
            <div class="user-header mb-3">
                <div class="d-flex align-items-center gap-2 mb-2">
                    <div class="profile-icon">
                        <img src="/images/default-avatar.png" alt="Profile" width="40" height="40">
                    </div>
                    <?php
                ...
                <button class="btn btn-success w-100" data-bs-toggle="modal" data-bs-target="#logoutConfirmModal">
                    Log Keluar
                </button>
            </div>
            ...
            <div class="sidebar-menu">
                ...
                <a href="/members/profile" class="menu-item">
                ...
                <a href="/members/dashboard" class="menu-item">
                ...
                <a href="/members/saving_acc" class="menu-item">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        ...
                                        <select name="loan_type" class="form-select" required>
                                            ...
                                            <option value="Pembiayaan_Al_Baiubithaman_Ajil">Pembiayaan Al-Baiubithaman Ajil</option>
                                            <option value="Pembiayaan_Bai_Al_Inah">Pembiayaan Bai Al-Inah</option>
                                            ...
                                            <option value="Pinjaman_Berjamin_Saham">Pinjaman Berjamin Saham</option>
                                            <option value="Skim_Khas_Pembelajaran">Skim Khas Pembelajaran</option>
                                        </select>
