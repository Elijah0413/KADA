                    ...
                    <div class="card shadow-sm h-100">
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <h6 class="card-title mb-0" style="font-size: 0.95rem;">Permohonan Pinjaman</h6>
                            </div>
                            <div class="d-flex justify-content-between align-items-baseline mb-3">
                                <div>
                                    <h2 class="mb-0" style="font-size: 1.75rem;"><?= $stats['loans']['pending'] ?? 0 ?></h2>
                                    <small class="text-muted" style="font-size: 0.85rem;">Dalam Proses</small>
                                </div>
                                <div class="text-end">
                                    <div class="mb-1" style="font-size: 0.9rem;">Jumlah: <?= $stats['loans']['total'] ?? 0 ?></div>
                                    <small class="text-success" style="font-size: 0.85rem;">Lulus: <?= $stats['loans']['approved'] ?? 0 ?></small>
                                    <small class="text-danger ms-2" style="font-size: 0.85rem;">Tolak: <?= $stats['loans']['rejected'] ?? 0 ?></small>
                                </div>
                            </div>
                    ...
                    <div class="card shadow-sm h-100">
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <h6 class="card-title mb-0" style="font-size: 0.95rem;">Pindahan Wang</h6>
                            </div>
                            <div class="d-flex justify-content-between align-items-baseline mb-3">
                                <div>
                                    <h2 class="mb-0" style="font-size: 1.75rem;"><?= $stats['transfers']['pending'] ?? 0 ?></h2>
                                    <small class="text-muted" style="font-size: 0.85rem;">Dalam Proses</small>
                                </div>
                                <div class="text-end">
                                    <div class="mb-1" style="font-size: 0.9rem;">Jumlah: <?= $stats['transfers']['total'] ?? 0 ?></div>
                                    <small class="text-success" style="font-size: 0.85rem;">Lulus: <?= $stats['transfers']['approved'] ?? 0 ?></small>
                                    <small class="text-danger ms-2" style="font-size: 0.85rem;">Tolak: <?= $stats['transfers']['rejected'] ?? 0 ?></small>
                                </div>
                            </div>
                            <div class="progress" style="height: 3px;">
                                <div class="progress-bar bg-secondary" role="progressbar" 
                    ...
                    <div class="card shadow-sm h-100">
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <h6 class="card-title mb-0" style="font-size: 0.95rem;">Keahlian</h6>
                            </div>
                            <div class="d-flex justify-content-between align-items-baseline mb-3">
                                <div>
                                    <h2 class="mb-0" style="font-size: 1.75rem;"><?= $stats['members']['pending'] ?? 0 ?></h2>
                                    <small class="text-muted" style="font-size: 0.85rem;">Dalam Proses</small>
                                </div>
                                <div class="text-end">
                                    <div class="mb-1" style="font-size: 0.9rem;">Jumlah: <?= $stats['members']['total'] ?? 0 ?></div>
                                    <small class="text-success" style="font-size: 0.85rem;">Lulus: <?= $stats['members']['approved'] ?? 0 ?></small>
                                    <small class="text-danger ms-2" style="font-size: 0.85rem;">Tolak: <?= $stats['members']['rejected'] ?? 0 ?></small>
                                </div>
                            </div>
                            <div class="progress" style="height: 3px;">
                                <div class="progress-bar bg-secondary" role="progressbar" 
                    ...
                    <div class="card shadow-sm h-100">
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <h6 class="card-title mb-0" style="font-size: 0.95rem;">Pertanyaan</h6>
                            </div>
                            <div class="d-flex justify-content-between align-items-baseline mb-3">
                                <div>
                                    <h2 class="mb-0" style="font-size: 1.75rem;"><?= $stats['inquiries']['pending'] ?? 0 ?></h2>
                                    <small class="text-muted" style="font-size: 0.85rem;">Belum Dijawab</small>
                                </div>
                                <div class="text-end">
                                    <div class="mb-1" style="font-size: 0.9rem;">Jumlah: <?= $stats['inquiries']['total'] ?? 0 ?></div>
                                    <small class="text-success" style="font-size: 0.85rem;">Selesai: <?= $stats['inquiries']['resolved'] ?? 0 ?></small>
                                    <small class="text-danger ms-2" style="font-size: 0.85rem;">Tolak: <?= $stats['inquiries']['rejected'] ?? 0 ?></small>
                                </div>
                            </div>
                            <div class="progress" style="height: 3px;">
                                <div class="progress-bar bg-secondary" role="progressbar" 
